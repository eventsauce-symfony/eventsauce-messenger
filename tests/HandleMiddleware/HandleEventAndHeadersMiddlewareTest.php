...
final class HandleEventAndHeadersMiddlewareTest extends TestCase
{
    /**
     * @test
     */
    public function should_handle_event_and_headers(): void
    {
        ...
        $middleware = new HandleEventAndHeadersMiddleware(
            new HandlersLocator([
